...
export function Preview({ asset, job, importFiles, importing, desktop }: Props) {
  ...
  useEffect(() => {
    ...
    const wheel = (event: WheelEvent) => {
      ...
      // React delegates wheel events passively; use a local non-passive listener
      // to prevent scrolling the canvas (or browser zoom) while scaling it.
