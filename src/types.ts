...
export interface ModelStatus { id: ModelId; displayName: string; category: string; name: string; nativeScales: number[]; qualityProfile: string; available: boolean; message: string; code: string | null }
export interface Engine { available: boolean; name: string; message: string; models: ModelStatus[] }
